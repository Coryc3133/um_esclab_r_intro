...
#### 2.4.2.1 Indexing Matrices Numerically
...
#### 2.4.2.1 Indexing Matrices by Name
...
mat["r1", 2]
```
#### Changing or Adding to Matrices with indexes
```{r}
mat[2, 2] <- mat[2, 2]^2
mat
```
...
### Exercise 2.4.2b
> Change the third row to be equal to the current third row times 3 and print the matrix.
...
For loops work a little bit like a function. Within the parantheses, you specify what is being iterated through, and you specify the body of the loop in `{}`:
